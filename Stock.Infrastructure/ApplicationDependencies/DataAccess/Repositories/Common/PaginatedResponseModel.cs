...
public class PaginatedResponseModel<TDto> : IPaginatedResponseModel<TDto>
{
    ...
    public PaginatedResponseModel(PaginatedQueryModel<TDto> queryModel, int rowCount, IEnumerable<TDto> results)
    {
        Results = results;
